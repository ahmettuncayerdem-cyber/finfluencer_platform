...
def run_topic_evolution(
    ...
    *,
    ...
    # Migration Step 3.3 (pending): still the old, configuration-string
    # resolution mechanism - see _resolve_scoped_topics_via_configuration's
    # docstring and test_scope_resolution_equivalence.py for the
    # equivalence proof required before this call site switches to
    # _resolve_scoped_topics_via_scope.
    scoped_topics = _resolve_scoped_topics_via_configuration(
