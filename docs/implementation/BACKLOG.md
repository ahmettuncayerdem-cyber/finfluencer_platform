...
**Epic progress:** EPIC-00 (Unfreeze the Repository) 1/3 tasks closed, 2 blocked-on-environment, no longer gating EPIC-01 (see Dependency Ruling below). EPIC-01 (Shared Foundation) 5/5 tasks closed (T-004, T-005, T-006, T-007, T-008 implementation — T-008's cross-vendor review outstanding, see its own entry). EPIC-02 (Walking Skeleton) 4/6 tasks closed for Sprint 0 scope (T-009 — Persistence-backed criterion deferred; T-010, T-011, T-013 — cross-vendor review outstanding; see each entry). EPIC-03 through EPIC-07: not started. EPIC-08 (Housekeeping, non-blocking): 1 task opened, not started.

**Sprint progress (Sprint 0 = EPIC-00 through EPIC-02):** T-001, T-004, T-005, T-006, T-007, T-008 (implementation), T-009 (Sprint 0 scope), T-010 (Sprint 0 scope), T-011 (Sprint 0 scope), T-013 (Sprint 0 scope) of 14 Sprint-0 tasks closed. Only T-012 (frontend) and T-014 (deploy — Sprint 0 exit gate) remain of the original 14.
...
**Not started:** T-012, T-014 through T-032 (T-009, T-010, T-011, and T-013 closed for Sprint 0 scope; T-009's full closure needs a future Persistence Layer task and API-layer routing; T-010's, T-011's, and T-013's need the still-outstanding cross-vendor review and, for T-010 eventually, a real network-backed provider adapter; T-011's async-dispatch/`IDatasetRepository`/`ResumeCollectionRunOrchestrator` gaps, and T-013's orchestrator-process-durability scope note, are flagged in their own entries). T-014 (Sprint 0 exit gate) now depends only on T-012 and T-013 — T-013 is closed, so T-012 (frontend) is the sole remaining blocker.
...
**Critical path, restated with current position:** `[T-001 ✅] → T-002 ⏸ (env-blocked, no longer gates T-006) → [T-006 ✅] → [T-007 ✅] → [T-008 ✅ impl., review outstanding] → [T-009 ✅ Sprint 0 scope] → [T-010 ✅ Sprint 0 scope, review outstanding] → [T-011 ✅ Sprint 0 scope, review outstanding] → [T-013 ✅ Sprint 0 scope, review outstanding] → T-014 (blocked only on T-012) → …` — T-004 ✅, T-005 ✅, T-006 ✅, T-007 ✅ closed. T-008/T-009/T-010/T-011 implemented 2026-08-01 (details in their own entries). T-013 implemented 2026-08-01: a new `tests/integration/` suite proves `IMPLEMENTATION_ROADMAP.md` line 63's Milestone 1 for real — a genuine `SIGKILL` of a real subprocess mid-collection, verified-correct partial checkpoint state, then a clean resume through the actual `StartCollectionRunOrchestrator` (T-011) with no data loss or row duplication in the final outputs. No new Domain/Application/Infrastructure abstraction; only a test-only subprocess worker script. 603 tests total this session across the full non-ML/non-CLI-version-mismatch suite plus the two new integration tests, all passing; a focused Walking Skeleton regression subset (T-007/T-008/T-009/T-010/T-011/T-013's own suites) also run in isolation, 112 passing; IG-001 clean. Cross-vendor review outstanding, same as T-008/T-009/T-010/T-011's own gates. EPIC-01 (Shared Foundation) is now 5/5 implemented; EPIC-02 (Walking Skeleton) 4/6 for Sprint 0 scope — only T-012 (frontend) and T-014 (deploy, gated on T-012) remain. Next unblocked task: **T-012** — its own dependencies (T-008 only) are already satisfied; re-confirm against this file before starting, same discipline as every prior task transition.
