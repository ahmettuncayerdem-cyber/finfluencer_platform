...
| 4 | Embeddings pipeline unwrapped — no source of `embeddings_index_path` for real `TopicsAnalysisAdapter` runs | **Release blocker** | `infrastructure/analysis/CONTEXT_PACK.md`; `GOVERNANCE_REGISTER.md` TD-05 (severity elevated this pass, §0.3) |
